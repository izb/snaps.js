define("sprites/spritedef",[],function(){function a(c,b,a){this.seq=c;this.dur=b;this.def=a}function d(c,b,a,d,g){this.states={};this.image=c;this.w=b;this.h=a;this.x=d;this.y=g}a.prototype.jogPos=function(c,b){var a;a=(b-c)%this.dur;return a/this.dur};a.prototype.draw=function(c,b,a,d,g,k){var l=this.def;d=this.seq[k?this.seq.length-1:Math.floor(this.seq.length*this.jogPos(d,g))];c.drawImage(l.image,d[0],d[1],l.w,l.h,b,a,l.w,l.h)};d.prototype.addState=function(c,b,d){for(var h=[],g=Math.floor(this.image.width/
this.w),k=0;k<b.length;k++){var l=b[k];h.push([this.w*(l%g),this.h*Math.floor(l/g)])}this.states[c]=new a(h,d,this)};return d});
define("sprites/sprite",[],function(){function a(a,c,b,e,h,g){g=g||{};this.def=c;this.sn=a;this.x="function"===typeof b?b():b;this.y="function"===typeof e?e():e;this.h="function"===typeof h?h():h;this.state=null;this.active=!0;this.maxloops=void 0===g.maxloops?0:"function"===typeof g.maxloops?g.maxloops():g.maxloops;this.updates=g.updates;this.id=g.id;this.endCallback=g.endCallback;this.collider=g.collider;this.autoRemove=g.autoRemove;void 0===this.autoRemove&&(this.autoRemove=!0);this.collisionPoint=
[0,0];this.quantizedHeight=!!g.quantizedHeight}a.prototype.init=function(){if(void 0!==this.updates)for(var a=0;a<this.updates.length;a++){var c=this.updates[a];c.init(this);c.hasOwnProperty("phaser")&&c.phaser.addSprite(this)}};a.prototype.maxDuration=function(){return 0===this.maxloops?0:this.state.dur*this.maxloops};a.prototype.isActive=function(a){this.active&&(0<this.maxloops&&this.state.dur*this.maxloops<=a-this.epoch)&&(this.active=!1,void 0!==this.endCallback&&this.autoRemove&&this.endCallback());
...
define("sprites/composite",["util/js","sprites/sprite"],function(a,d){function c(a,b,c,d,e){this.sn=a;this.x=b;this.y=c;this.endCallback=e;this.active=!0;this.sprites=[]}var b=a.copyProps,e=a.clone;c.prototype.init=function(){};c.prototype.addSprite=function(a,c,k,l,n,m){void 0===m&&(m={});a=this.sn.spriteDefs[a];var q=m.updates;if(void 0!==q)for(var q=Array(m.updates.length),v=0;v<m.updates.length;v++)q[v]=new this.sn.spriteUpdaters[m.updates[v].name],b(m.updates[v],q[v]);m=e(m);m.updates=q;k=new d(this.sn,
...
define("util/all","util/preload util/rnd util/bitmap util/debug util/js util/uid util/url".split(" "),function(a,d,c,b,e,h,g){return{Preloader:a,rnd:d,js:e,uid:h,debug:b,Bitmap:c,Url:g}});
...
(a[b]=parseInt(a[b],10));return a};e.prototype.resolveTiles=function(){var b,c,d,e,g,h=this.data;for(d=h.tilesets.length-1;0<=d;d--)e=h.tilesets[d],e.xspan=Math.floor(e.imagewidth/e.tilewidth),e.yspan=Math.floor(e.imageheight/e.tileheight);for(b=0;b<h.layers.length;b++){var s=h.layers[b];s.rows=[];var r=[];for(c=0;c<s.data.length;c++){var w=s.data[c];if(0===w)r.push(null);else{for(d=h.tilesets.length-1;0<=d&&!(e=h.tilesets[d],e.firstgid<=w);d--);d=w-e.firstgid;var w=Math.floor(d/e.xspan),p=d-e.xspan*
w;g=e.tileheight-h.tileheight;this.maxXOverdraw=Math.max(e.tilewidth-h.tilewidth,this.maxXOverdraw);this.maxYOverdraw=Math.max(g,this.maxYOverdraw);g=void 0;void 0!==e.tileproperties&&e.tileproperties.hasOwnProperty(d)&&(g=e.tileproperties[d]);r.push(new a(e.image,p*e.tilewidth,w*e.tileheight,e.tilewidth,e.tileheight,e.tilewidth-h.tilewidth,e.tileheight-h.tileheight,k(e.properties),k(g)))}r.length>=s.width&&(s.rows.push(r),r=[])}}};e.prototype.drawDebugRegions=function(a){var b=this.data,c,e,d,g,
k,r,w=b.tilewidth,p=b.tileheight/2;k=Math.floor((this.yoffset-p)/p);e=Math.floor((this.yoffset+this.clientHeight-p+this.maxYOverdraw)/p)+1;d=Math.floor((this.xoffset+this.clientWidth-1)/w);r=Math.floor((this.xoffset-w/2-this.maxXOverdraw)/w);c=b.layers[0];c=Math.min(e,c.rows.length-1);for(e=Math.max(r,0);k<=c;k++){var t;k&1?(r=b.tilewidth/2,t="#f00"):(r=0,t="#0f0");for(g=d;g>=e;g--){a.strokeStyle=t;var u=Math.floor(-this.xoffset)+r+g*w,f=Math.floor(-this.yoffset)+k*p,x=b.tilewidth,z=b.tileheight;
a.strokeRect(u,f,x,z);a.strokeStyle="#aaa";a.beginPath();a.moveTo(u,f+z/2);a.lineTo(u+x/2,f);a.lineTo(u+x,f+z/2);a.lineTo(u+x/2,f+z);a.closePath();a.stroke()}}c=b.layers[0];for(k=0;k<c.rows.length;k++){d=c.rows[k];r=k&1?b.tilewidth/2:0;for(g=d.length-1;0<=g;g--)h(a,g+","+k,85+Math.floor(-this.xoffset)+r+g*w,55+Math.floor(-this.yoffset)+k*p)}};e.prototype.scrollTo=function(a,b){this.xoffset=a;this.yoffset=b;this.xoffset<this.minxoffset?this.xoffset=this.minxoffset:this.xoffset>this.maxxoffset&&(this.xoffset=
...
define("plugins/sprite/8way",[],function(){function a(){}var d;a.prototype.update=function(a,b){var e=this.sprite,d=e.directionx-e.x,g=2*(e.directiony-e.y);if(0===g)d=0===d?this.direction:0<d?"e":"w";else var k=d/g,d=0<=k?0.41421>k?0<g?"s":"n":2.4142<k?0<d?"e":"w":0<d?"se":"nw":-0.41421<k?0<g?"s":"n":-2.4142>k?0<d?"e":"w":0<d?"ne":"sw";this.direction=d;this.oldx=e.x;this.oldy=e.y;e.setState(e.stateName,this.direction);return!0};a.prototype.init=function(a){this.sprite=a;this.direction="e"};a.prototype.onSpriteRemoved=
...
a.spriteOpts).particleData={xspeed:h(-400,400)/1E3,hspeed:h(-600,50)/1E3,xaccell:0,haccell:0.001,startx:c.x||0,starth:c.h||0,epoch:this.epoch}}var e,h=c.rnd,g=function(a,b){var c=a.particleData,d=b-c.epoch,e=d*d;a.x=Math.floor(c.startx+(c.xspeed*d+c.xaccell*e/2));a.h=Math.floor(c.starth-(c.hspeed*d+c.haccell*e/2));0>a.h&&(a.h=0)};b.prototype.update=function(a){this.comp.update(a,g.bind(this));if(void 0!==this.duration&&a-this.epoch>this.duration)return void 0!==this.endCallback&&this.endCallback(),
...
define("plugins/ai/phasers/time-phaser",[],function(){function a(a,b){this.id=a;b=b||{};if(void 0===b.updatesPerSecond||1>b.updatesPerSecond)throw"Time phasers must define a >0 number of updates per second.";this.updatesPerSecond=b.updatesPerSecond;this.updatesThisFrame=this.lastUpdate=0;this.sprites=[]}var d;a.prototype.phase=function(a,b){var d=a.phaserData[this.id];d.phaseOn&&(d.lastUpdate=b);return d.phaseOn};a.prototype.addSprite=function(a){void 0===a.phaserData&&(a.phaserData={});a.phaserData[this.id]=
{lastUpdate:0};this.sprites.push(a)};a.prototype.removeSprite=function(a){delete a.phaserData[this.id]};a.prototype.rebalance=function(a){var b=a-this.lastUpdate;this.lastUpdate=a;var d=Math.floor(b*this.updatesPerSecond/1E3),h=this.id,g=this.sprites;g.sort(function(a,b){return b.phaserData[h].lastUpdate-a.phaserData[h].lastUpdate});var k=0;for(a=g.length-1;0<=a;a--)b=g[a],b.phaserData.hasOwnProperty(this.id)?b.phaserData[this.id].phaseOn=0<d--:k++;if(0<k){g=[];d=this.sprites.length;for(a=0;a<d;a++)b=
g[a],b.phaserData.hasOwnProperty(this.id)&&g.push(b);this.sprites=g}};return function(c){d=c;d.registerPhaserPlugin("time-phaser",a)}});
...
function(a){delete a.phaserData[this.id]};a.prototype.rebalance=function(a){var b,d,h=0,g=this.buckets,k=this.sprites,l=k.length/this.phases;for(a=g.length-1;0<=a;a--)g[a]=0,this.bucketMax[a]=Math.floor((a+1)*l-Math.floor(a*l));var n=[],m=0;for(a=k.length-1;0<=a;a--)b=k[a],b.phaserData.hasOwnProperty(this.id)?(d=b.phaserData[this.id],d.phase++,d.phase>=this.phases&&(d.phase=0),h=Math.max(h,++g[d.phase]),g[d.phase]>this.bucketMax[d.phase]&&n.push(b)):m++;if(0.8>l/h){k=0;for(a=n.length-1;0<=a;a--){for(b=
n[a];g[k]>=this.bucketMax[k];)k++,k===this.phases&&(k=0);d=b.phaserData[this.id];g[d.phase]--;d.phase=k;g[k]++}}if(0<m){k=[];d=this.sprites.length;for(a=0;a<d;a++)b.phaserData.hasOwnProperty(this.id)&&k.push(this.sprites[a]);this.sprites=k}};return function(c){d=c;d.registerPhaserPlugin("frame-phaser",a)}});
...
define("plugins/collision/lib/prop-scanner",[],function(){return function(a,d,c,b,e,h,g,k,l,n){var m=b,q=e,v=h,y=g,s,r=b+h|0,w=e+g|0;b|=0;e|=0;h=Math.abs(r-b);g=Math.abs(w-e);var p=0;void 0!==n&&(n.length=0,n.length=2*(Math.max(h,g)+1));if(0===h&&0===g)return l[0]=b,l[1]=e,a.getTilePropAtWorldPos(d,b,e),1;var t=b<r?1:-1,u=e<w?1:-1,f=h-g,x=!1,z=b,A=e;void 0!==n&&(n[p++]=b,n[p++]=e);s=2*f;s>-g&&(f-=g,b+=t);s<h&&(f+=h,e+=u);for(;;){if(b<c.le||b>c.re||e<c.te||e>c.be){x=!0;break}s=a.getTilePropAtWorldPos(d,
b,e);if(s>k){x=!0;break}z=b;A=e;void 0!==n&&(n[p++]=b,n[p++]=e);if(b===r&&e===w)break;s=2*f;s>-g&&(f-=g,b+=t);s<h&&(f+=h,e+=u)}x?void 0!==l&&(l[0]=z,l[1]=A):void 0!==l&&(l[0]=m+v,l[1]=q+y);void 0!==n&&(n.length=p);return!x?1:h>g?(l[0]-m)/v:(l[1]-q)/y}});
...
define("plugins/collision/lib/ellipse",[],function(){return function(a,d){var c=a*a,b=d*d,e=2*c,h=2*b,g,k=0,l=d,n=0,m=e*l,q=[];q.push(k,l,-k,l,k,-l,-k,-l);for(g=Math.round(b-c*d+0.25*c);n<m;)k++,n+=h,0>g?g+=b+n:(l--,m-=e,g+=b+n-m),q.push(k,l,-k,l,k,-l,-k,-l);for(g=Math.round(b*(k+0.5)*(k+0.5)+c*(l-1)*(l-1)-c*b);0<l;)l--,m-=e,0<g?g+=c-m:(k++,n+=h,g+=c-m+n),q.push(k,l,-k,l,k,-l,-k,-l);return q}});
...
y,s;if(this.autoSlip){var r=0;for(s=this.samples.length-2;0<=s;s-=2)if(v=this.samples[s],y=this.samples[s+1],v=h(e,b+v,c+y,m,d,n),0===r)r=v;else if(0!==v&&r!==v){r=0;break}c+=r}var r=[],w=a(e,"height",this.edges,b,c,d,n,m,this.lineHit,r),p,t,u=!0;for(s=r.length-2;2<=s&&u;s-=2){for(var u=!1,f=this.samples.length-2;0<=f;f-=2)if(v=this.samples[f],y=this.samples[f+1],p=r[s],t=r[s+1],e.getTilePropAtWorldPos("height",p+v,t+y)>m){u=!0;break}if(!u){if(s===r.length-2)return q[0]=this.lineHit[0],q[1]=this.lineHit[1],
...
define("snaps","sprites/spritedef sprites/sprite sprites/composite input/keyboard input/mouse util/all map/staggered-isometric plugins/default-plugins animate/tween ai/proximity-tracker polyfills/requestAnimationFrame polyfills/bind".split(" "),function(a,d,c,b,e,h,g,k,l,n){function m(m,p,t){function u(a){315532800<a&&0===f.epoch&&(f.epoch=a-16);a-=f.epoch;f.now=a;f.requestAnimationFrame(u);f.updateFX();f.map.updateLayers(a);f.updatePhasers();z(a-f.lastFrameTime);f.updateSprites();f.camera&&f.camera.update(a);
...
function(a,b){f.phaserPlugins[a]={fn:b}};k(this);if("function"===typeof f.game.onEngineStart)f.game.onEngineStart(this);p=new s;void 0!==this.map&&this.map.primePreloader(p);if("object"===typeof m.preloadImages){t=function(a,b){f.imageCache[b]=a};for(var A in m.preloadImages)p.add(m.preloadImages[A],A,t)}if("object"===typeof f.game.spriteDefs){m=function(b,c){var d=f.game.spriteDefs[c],e=new a(b,d.w,d.h,d.x,d.y);f.spriteDefs[c]=e;for(var g in d.states)e.addState(g,d.states[g].seq,d.states[g].dur)};
for(var B in f.game.spriteDefs)p.add(f.game.spriteDefs[B].path,B,m)}this.drawImage=function(a,b,c){f.ctx.drawImage(f.imageCache[a],b,c)};this.cls=function(a){f.ctx.fillStyle=a||"#000";f.ctx.fillRect(0,0,f.clientWidth,f.clientHeight)};this.bindKeys=function(a){for(var b=0;b<a.length;b++){var c=a[b];f.keyboard.bind(c.key,c.action)}};this.updatePhasers=function(){for(var a=f.phasers.length-1;0<=a;a--)f.phasers[a].rebalance(f.now)};this.updateFX=function(){for(var a=f.activeFX.length-1;0<=a;a--)f.activeFX[a].update(f.now)||
f.activeFX.splice(a,1)};this.fx=function(a,b){if(!f.fxUpdaters.hasOwnProperty(a))throw"Can't create FX for unregistered FX type: "+a;f.activeFX.push(new f.fxUpdaters[a](b))};this.addLayer=function(a,b,c,d){if(!f.layerPlugins.hasOwnProperty(b))throw"Can't create layer for unregistered layer type: "+b;a=new f.layerPlugins[b](a,c);f.map.insertLayer(d,a);return a};this.spriteCount=function(){for(var a=0,b=0;b<f.sprites.length;b++){var d=f.sprites[b];d instanceof c?a+=d.sprites.length:a++}return a};p.load(function(){void 0!==
f.map&&f.map.resolveTiles();if("function"===typeof f.game.onResourcesLoaded)f.game.onResourcesLoaded();setTimeout(function(){u(0)},0)},function(a){if("function"===typeof f.game.onProgress)f.game.onProgress(a,f.ctx)},function(){if("function"===typeof f.game.onLoadError)f.game.onLoadError()});this.actioning=function(a){return f.keyboard.actionPressed(a)};this.scroll=function(a,b){f.map.scroll(a,b)};this.scrollTo=function(a,b){f.map.scrollTo(a,b)};this.getWorldEdges=function(){return f.map.getWorldEdges()};
this.drawWorld=function(){this.map.drawWorld(f.ctx,f.now,f.sprites)};this.drawSpriteWorld=function(a){f.spriteMap[a].draw(f.ctx,f.map.xoffset,f.map.yoffset,f.now)};this.mouseScreenPos=function(a){a[0]=f.mouse.x;a[1]=f.mouse.y};this.mouseWorldPos=function(a){f.map.screenToWorldPos(f.mouse.x,f.mouse.y,a)};this.worldToTilePos=function(a,b,c){this.map.worldToTilePos(a,b,c)};this.screenToTilePos=function(a,b,c){this.map.screenToTilePos(a,b,c)};this.screenToWorldPos=function(a,b,c){this.map.screenToWorldPos(a,
b,c)};this.worldToScreenPos=function(a,b,c){this.map.worldToScreenPos(a,b,c)};this.getTilePropAtWorldPos=function(a,b,c){return this.map.getTilePropAtWorldPos(a,b,c)};this.createCollider=function(a,b){if(!f.colliders.hasOwnProperty(a))throw"Warning: undefined collider plugin: "+a;return new f.colliders[a].fn(b)};this.createCamera=function(a,b,c){if(!f.cameraPlugins.hasOwnProperty(b))throw"Warning: undefined camera plugin: "+b;if(this.cameras.hasOwnProperty(a))throw"Camera already exists: "+a;this.cameras[a]=
new f.cameraPlugins[b].fn(c);return this.cameras[a]};this.switchToCamera=function(a){this.camera=this.cameras[a]};this.spawnSprite=function(a,b,c,e,g,k,h){void 0===h&&(h={});var l=h.id;if(void 0===l)l=r();else if(f.spriteMap.hasOwnProperty(l))throw"Error: duplicate sprite id "+l;if(!f.spriteDefs.hasOwnProperty(a))throw"Error: Missing sprite definition when spawning sprite "+a;a=f.spriteDefs[a];var m=h.updates;if(void 0!==m)for(var m=Array(h.updates.length),n=0;n<h.updates.length;n++){var p=h.updates[n],
q=p.name;if(!f.spriteUpdaters.hasOwnProperty(q))throw"Sprite plugin used but not registered: "+q;m[n]=new f.spriteUpdaters[q];v(p,m[n])}h=y(h);h.updates=m;e=new d(f,a,e,g,k,h);e.setState(b,c);if(void 0!==h.opts)for(var s in h.opts)e[s]=h.opts[s];e.init();f.sprites.push(e);return f.spriteMap[l]=e};this.createComposite=function(a,b,d,e){if(void 0===d)d=r();else if(f.spriteMap.hasOwnProperty(d))throw"Warning: duplicate sprite (composite) id "+d;a=new c(this,a,b,d,e);a.init();f.sprites.push(a);return f.spriteMap[d]=
a};this.markTime=function(a,b){f.timers[a]=f.now+b};this.checkTimer=function(a,b){if(void 0===f.timers[a])return!1;var c=f.timers[a];if(0<f.now-c){if(void 0===b)delete f.timers[a];else{b=Math.max(1,b);do c+=b;while(c<f.now);f.timers[a]=c}return!0}return!1};this.sprite=function(a){return f.spriteMap[a]};this.updateSprites=function(){for(var a=[],b=0;b<f.sprites.length;b++){var c=f.sprites[b];c.isActive(f.now)?(c.update(f.now),a.push(c)):(c.onRemove(),delete f.spriteMap[c.name])}f.sprites=a};this.getNow=
function(){return f.now};this.createPhaser=function(a,b){if(!f.phaserPlugins.hasOwnProperty(a))throw"Can't create phaser for unregistered type: "+a;var c=new f.phaserPlugins[a].fn(r(),b);this.phasers.push(c);return c};this.resizeCanvas=function(){}}var q=h.debug.debugText,v=h.js.copyProps,y=h.js.clone,s=h.Preloader,r=h.uid;m.util=h;return m});
