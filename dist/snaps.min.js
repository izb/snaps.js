...
define("util/all","util/preload util/rnd util/bitmap util/debug util/js util/guid util/url".split(" "),function(a,d,c,b,e,k,g){return{Preloader:a,rnd:d,js:e,guid:k,debug:b,Bitmap:c,Url:g}});
...
define("plugins/sprite/follow-mouse",[],function(){function a(){}var d=[0,0],c;a.prototype.update=function(a,e){c.mouseWorldPos(d);var k=this.sprite;k.x=d[0];k.y=d[1];return!0};a.prototype.init=function(){};return function(b){c=b;c.registerSpriteUpdater("follow_mouse",a)}});
...
this.tween;this.tweenfn=d.tweens[this.tween];this.epoch=d.getNow()};return function(c){d=c;d.registerSpriteUpdater("animate",a)}});
...
0,a.spriteOpts).particleData={xspeed:k(-400,400)/1E3,hspeed:k(-600,50)/1E3,xaccell:0,haccell:0.001,startx:c.x||0,starth:c.h||0,epoch:this.epoch}}var e,k=c.rnd,g=function(a,b){var c=a.particleData,d=b-c.epoch,e=d*d;a.x=Math.floor(c.startx+(c.xspeed*d+c.xaccell*e/2));a.h=Math.floor(c.starth-(c.hspeed*d+c.haccell*e/2));0>a.h&&(a.h=0)};b.prototype.update=function(a){this.comp.update(a,g.bind(this));if(void 0!==this.duration&&a-this.epoch>this.duration)return void 0!==this.endCallback&&this.endCallback(),
...
-59*b*b+32*a+-5*b)}}});define("ai/proximity-tracker",[],function(){function a(a,c){if(2>c||0!==(c&1)||c!==c|0)throw"Cell size must be an even integer > 0";this.cellw=c;this.cellh=c/2;this.sn=a;var b=a.getWorldEdges();this.le=b.le;this.re=b.re;this.te=b.te;this.be=b.be}a.prototype.track=function(a){};return a});
...
return f.spriteMap[l]=e};this.createComposite=function(a,b,d,e){if(void 0===d)d=s();else if(f.spriteMap.hasOwnProperty(d))throw"Warning: duplicate sprite (composite) name "+d;a=new c(this,a,b,e);a.init();f.sprites.push(a);return f.spriteMap[d]=a};this.markTime=function(a,b){f.timers[a]=f.now+b};this.checkTimer=function(a,b){if(void 0===f.timers[a])return!1;var c=f.timers[a];if(0<f.now-c){if(void 0===b)delete f.timers[a];else{b=Math.max(1,b);do c+=b;while(c<f.now);f.timers[a]=c}return!0}return!1};
this.sprite=function(a){return f.spriteMap[a]};this.updateSprites=function(){for(var a=[],b=0;b<f.sprites.length;b++){var c=f.sprites[b];c.isActive(f.now)?(c.update(f.now),a.push(c)):delete f.spriteMap[c.name]}f.sprites=a};this.getNow=function(){return f.now};this.createPhaser=function(a,b){if(!f.phaserPlugins.hasOwnProperty(a))throw"Can't create phaser for unregistered type: "+a;var c=new f.phaserPlugins[a].fn(s(),b);this.phasers.push(c);return c};this.resizeCanvas=function(){}}var q=k.debug.debugText,
v=k.js.copyProps,y=k.js.clone,r=k.Preloader,s=k.guid;m.util=k;return m});
